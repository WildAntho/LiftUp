export default function IllustrationProgram() {
  return (
    <div className="p-8 h-[300px] font-sans relative flex items-center justify-center shadow-sm">
      ...
      <div className="absolute right-64 z-1">
        <img src="/phone.png" alt="Illustration" className="w-44" />
      </div>
      ...
      <div className="relative z-10 w-[70%]">
        ...
        <h2 className="text-2xl text-primary font-bold mb-4">
          Découvre tous les programmes d'entraînements.
        </h2>
        <p className="text-gray-600 mb-6 text-sm">
          Choisis celui qui t’aidera au mieux dans ta pratique !
        </p>
      </div>
    </div>
  );
